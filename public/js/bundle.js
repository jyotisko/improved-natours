        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/users/".concat(type === 'login' ? 'login' : 'signup'),
              data: data
            });
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('User validation failed: passwordConfirm')) msg = 'Your passwords does not match!';
...
var stripe = Stripe('pk_test_51Iw5YUSCycbhEIix2Dycsst4GDMcrfShWRYXhISxlt5Y4vpQdmmfGOJB7R1VxhlnIWXBHxNbchzw2M4rPp4CWg8X00ewLYIx44');
...
exports.deleteReview = exports.submitReview = exports.starHandler = void 0;
...
var starHandler = function starHandler() {
  var reviewFormStars = document.querySelectorAll('.reviews__star--rating');
  return reviewFormStars.forEach(function (reviewStar) {
    reviewStar.addEventListener('click', function () {
      var id = reviewStar.dataset.id;
      reviewFormStars.forEach(function (star) {
...
exports.starHandler = starHandler;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data === '') (0, _alerts.showAlert)('success', 'Review deleted successfully!');
            _context2.next = 10;
            break;
...
var deleteReviewBtn = document.querySelectorAll('.delete-icon'); // DELEGATION
...
if (reviewFormStars) {
  (0, _review.starHandler)();
}

if (reviewForm) {
  reviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var _document$querySelect, tour, user, rating, review;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              e.preventDefault();
              _document$querySelect = document.querySelector('.review__ratings').dataset, tour = _document$querySelect.tour, user = _document$querySelect.user, rating = _document$querySelect.rating;
              review = document.querySelector('#review-text').value;
              _context3.next = 6;
              return (0, _review.submitReview)({
                tour: tour,
                user: user,
                rating: rating,
                review: review
            ...
            case 9:
              ...
              if (!(_context3.t0.message === 'Please provide a rating!')) {
                _context3.next = 13;
                break;
              }

              return _context3.abrupt("return", (0, _alerts.showAlert)('error', 'Please provide a rating!'));
...
if (deleteReviewBtn) {
  deleteReviewBtn.forEach(function (btn) {
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./mapbox.js":"mapbox.js","./auth.js":"auth.js","./updateSettings.js":"updateSettings.js","./stripe.js":"stripe.js","./review":"review.js","./alerts.js":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
